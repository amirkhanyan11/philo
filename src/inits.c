...
/*   Updated: 2024/07/04 16:26:22 by aamirkha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	__init__minit(t_table *table, char **av)
{
	...
	if (any_of(doesnt_have_value, &num_of_philos, &time_to_die, &time_to_sleep, &time_to_eat, NULL) ||
			any_of(has_bad_timeval, &time_to_die, &time_to_sleep, &time_to_eat, NULL) || value(&num_of_philos) < 1
